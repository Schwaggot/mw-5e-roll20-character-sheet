  ...
  const TRAIT_EFFECTS = {
    ...
    commanding:  { attr: { charisma: 2, dexterity: -2 },
                   note: "Auto: +2 CHA, -2 DEX. | Manuell: Proficiency in Persuasion. 1x pro Short Rest als Bonus Action: Verbündeter in 30 ft erhält +2 auf nächsten Angriffs- oder Rettungswurf." },
    connected:   { attr: { charisma: 2, constitution: -2 },
                   note: "Auto: +2 CHA, -2 CON. | Manuell: Proficiency in Persuasion ODER Deception (Wahl). 1x pro Session: Kontakt aktivieren (GM definiert Bekanntschaft/Gefallen/Info)." },
    ...
    lucky:       { note: "Auto: nichts (Choice). | Manuell: +2/-2 auf je 1 Attribut. 1x pro Long Rest: einen d20 (eigener Wurf oder Angriff gegen dich) neu würfeln und Ergebnis wählen." },
    ...
    steady:      { attr: { constitution: 2, charisma: -2 },
                   note: "Auto: +2 CON, -2 CHA. | Manuell: Advantage auf Saves gegen Frightened und gegen Shaken-Level durch Stress-Damage." },
    stoic:       { attr: { wisdom: 2, intelligence: -2 },
                   note: "Auto: +2 WIS, -2 INT. | Manuell: Proficiency in Insight. Advantage gegen Intimidation, Persuasion, Deception und Charmed." },
